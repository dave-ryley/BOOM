local P = {}
	local function spawn()
		...
		V.upperBodyAnim = ""
		V.sounds = {}
		V.sounds.boomStick = audio.loadSound(g.soundsPath.."Player/BOOMSTICK.ogg")
		V.sounds.step1 = audio.loadSound( g.soundsPath.."Player/Step1.ogg" )
		V.sounds.step2 = audio.loadSound( g.soundsPath.."Player/Step2.ogg" )
		V.sounds.torchIdle = audio.loadSound( g.soundsPath.."Player/TorchIdle.ogg" )
		...
		local lowerBodyRun_sheet = graphics.newImageSheet( g.animationPath.."RunnerLegs.png", runSheetOptions )
		...
		local upperBodyRun_sheet = graphics.newImageSheet( g.animationPath.."RunnerTorso.png", runUpperSheetOptions )
		...
		local torch_sheet = graphics.newImageSheet( g.animationPath.."Torch.png",
													torchSheetOptions )
